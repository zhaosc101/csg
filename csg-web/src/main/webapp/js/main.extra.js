...
'vars' in window.ace || (window.ace.vars = {
    ...
    ace.settings = {
        ...
        sidebar_fixed: function (a, b, c, d) {
            ...
            if (b && d !== !1 && !ace.settings.is('navbar', 'fixed') && ace.settings.navbar_fixed(null, !0, c), b) {
                ...
                var f = document.getElementById('menu-toggler');
                f && ace.removeClass(f, 'fixed'),
                c !== !1 && ace.settings.unset('sidebar', 'fixed')
            }
            try {
        ...
        breadcrumbs_fixed: function (a, b, c, d) {
            ...
            b = b || !1,
                c = c && !0,
            b && d !== !1 && !ace.settings.is('sidebar', 'fixed') && ace.settings.sidebar_fixed(null, !0, c),
                b ? (ace.hasClass(a, 'breadcrumbs-fixed') || ace.addClass(a, 'breadcrumbs-fixed'), c !== !1 && ace.settings.set('breadcrumbs', 'fixed'))  : (ace.removeClass(a, 'breadcrumbs-fixed'), c !== !1 && ace.settings.unset('breadcrumbs', 'fixed'));
            try {
        ...
        sidebar_collapsed: function (a, b, c) {
            ...
            var a = a || '#sidebar';
            if ('string' == typeof a && (a = document.querySelector(a)), !a) return !1;
            if (b = b || !1, b ? (ace.addClass(a, 'menu-min'), c !== !1 && ace.settings.set('sidebar', 'collapsed'))  : (ace.removeClass(a, 'menu-min'), c !== !1 && ace.settings.unset('sidebar', 'collapsed')), window.jQuery && jQuery(document).trigger('settings.ace', [
                    'sidebar_collapsed',
                    b,
                    a
                ]), !window.jQuery) {
                ...
                var e,
                    f,
                    g = d.querySelector('[data-icon1][data-icon2]');
                if (!g) return;
                e = g.getAttribute('data-icon1'),
                    f = g.getAttribute('data-icon2'),
                    b ? (ace.removeClass(g, e), ace.addClass(g, f))  : (ace.removeClass(g, f), ace.addClass(g, e))
            }
        }
    },
    ...
    ace.data_storage = function (a, b) {
        var c = 'ace_',
            d = null,
            e = 0;
        (1 == a || a === b) && 'localStorage' in window && null !== window.localStorage ? (d = ace.storage, e = 1)  : null == d && (2 == a || a === b) && 'cookie' in document && null !== document.cookie && (d = ace.cookie, e = 2),
            this.set = function (a, b, f, g, h) {
                if (d) if (f === h) f = b,
                    b = a,
    ...
    ace.cookie = {
        ...
        set: function (a, b, c, d, e, f) {
            var g = new Date;
            'object' == typeof c && c.toGMTString ? c = c.toGMTString()  : parseInt(c, 10) ? (g.setTime(g.getTime() + 1000 * parseInt(c, 10)), c = g.toGMTString())  : c = '',
